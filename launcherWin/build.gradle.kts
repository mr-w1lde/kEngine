...
val lwjglPlatform = "natives-windows"
...
dependencies {
    ...
    implementation("io.github.spair:imgui-java-natives-windows:${project.extra["imguiVersion"]}")
...
tasks {
    ...
    runShadow {
        val args = listOf("-Dorg.lwjgl.util.Debug=true")
